...
<Note>
  The current intent recognition is designed for full-sentence matching. We will be expanding into "slot filling" techniques to extract quantities like "I want ten bananas".
</Note>

Coming soon: Extract parameters from utterances automatically.
