...
<CardGroup cols={2}>
  <Card title="API Reference" icon="code" href="/api-reference/python">
    Detailed API documentation
  </Card>
  <Card title="Models" icon="brain" href="/models">
    Available models and architectures
  </Card>
  <Card title="Examples" icon="flask" href="/examples/python">
    More Python examples
  </Card>
  <Card title="Troubleshooting" icon="wrench" href="/troubleshooting/python">
