...
<CardGroup cols={2}>
  ...
  <Card title="Intent Recognition" icon="brain" href="/concepts/intent-recognition">
    Advanced command recognition
  </Card>
  <Card title="GPIO Projects" icon="microchip" href="/resources/examples">
    More Raspberry Pi projects
  </Card>
  <Card title="Models" icon="download" href="/models/overview">
